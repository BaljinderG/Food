...
<?php include_once 'header.php'; ?>
 ...
 <!--Main-->
<main  class="main position-relative signInPage" >
            ...
            <div class="container">
               ...
               <div class="row justify-content-center align-items-center">
                  <div class="col-12 col-md-6 col-lg-4 order-lg-1 order-2">
                     <!-- img -->
                     <img src="images/login-orange.png" alt="" class="img-fluid">
                  </div>
                  <!-- col -->
                  <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
                     <div class="mb-lg-9 mb-5">
                        <h1 class="mb-1 h2 fw-bold">Sign in to GoodFood</h1>
                        <p>Welcome back to GoodFood! Enter your email to get started.</p>
                     </div>
